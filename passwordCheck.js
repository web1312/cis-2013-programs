...
var passwordCheckOld = function () 
{
    ...
    //inputs user password to javascript
    ...
    stringOutput = "";
    //tests to see if the password is at least 8 characters long
    if(stringPassword.length < 8)
    {
        ...
        for(i = 0; i<arrayBadPasswords.length; i++){ //checks if the user's password is in list of bad passwords
            ...
            else{  //if password meets all criteria, returns that the user's password is strong
                stringOutput = "Selected password is strong.";
            }
        }
